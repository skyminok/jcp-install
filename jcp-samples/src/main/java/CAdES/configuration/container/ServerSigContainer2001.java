/**
 * $RCSfileServerSigContainer2001.java,v $
 * version $Revision: 36379 $
 * created 17.12.2014 11:39 by afevma
...
/**
 * Служебный класс ServerSigContainer2001 предоставляет
 * алиас и пароль для доступа к контейнеру с серверным
 * сертификатом и ключом подписи на алгоритме ГОСТ Р 34.10-2001.
 *
