 ...
 * В качестве алгоритома экспорта используются явно заданные MGM_K_EXPORT и MGM_M_EXPORT, либо
 * обобщенный алгоритм MGM_EXPORT (в этом случае конкретный алгоритм MGM_K_EXPORT и MGM_M_EXPORT
 ...
 * @.Version
 */
public class KuznechikExportMgmExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        main_(JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME + "/MGM_M_EXPORT/NoPadding", 8, 8);
        // Экспорт ключа Кузнечик на ключе Магма
        main_(JCP.GOST_K_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME + "/MGM_M_EXPORT/NoPadding", 16, 8);
        // Экспорт ключа Магма на ключе Кузнечик
        main_(JCP.GOST_M_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME + "/MGM_K_EXPORT/NoPadding", 8, 16);
        // Экспорт ключа Кузнечик на ключе Кузнечик
        main_(JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME + "/MGM_K_EXPORT/NoPadding",16, 16);

        // Экспорт ключа Магма на ключе Магма
        main_(JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME + "/MGM_EXPORT/NoPadding", 8, 8);
        // Экспорт ключа Кузнечик на ключе Магма
        main_(JCP.GOST_K_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME, JCP.GOST_M_CIPHER_NAME + "/MGM_EXPORT/NoPadding", 16, 8);
        // Экспорт ключа Магма на ключе Кузнечик
        main_(JCP.GOST_M_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME + "/MGM_EXPORT/NoPadding", 8, 16);
        // Экспорт ключа Кузнечик на ключе Кузнечик
        main_(JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME, JCP.GOST_K_CIPHER_NAME + "/MGM_EXPORT/NoPadding",16, 16);
     ...
     * @throws Exception
     */
    public static void main_(String encryptDataAlg, String keyAlg,  String wrapAlg,
        ...
        KeyGenerator kgExp = KeyGenerator.getInstance(keyAlg, PROVIDER_NAME);
