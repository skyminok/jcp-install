/**
 * $RCSfileJCSPEnvelopedCMSAsStreamExample.java,v $
...
import CAdES.enveloped.JCPEnvelopedCMSAsStreamExample;
import ru.CryptoPro.JCP.Util.JCPInit;

/**
 * Пример создания и расшифрования подписи Enveloped CMS из
 * Signed CMS в потоке с помощью провайдера Java CSP.
 *
 * @author Copyright 2004-2014 Crypto-Pro. All rights reserved.
 * @version 2.5
 */
public class JCSPEnvelopedCMSAsStreamExample extends JCPEnvelopedCMSAsStreamExample {
