/**
 * $RCSfileEnvelopedCMSAsByteArrayExample.java,v $
 * version $Revision: 36379 $
 * created 24.07.2014 9:08 by afevma
...
/**
 * Пример создания подписи формата Enveloped CMS из Signed CMS
 * (CMS подписи) на разных алгоритмах.
 *
...
public class EnvelopedCMSAsByteArrayExample implements IEnvelopedData {
     ...
     * @throws Exception
     */
    public static void envelope(IConfiguration signerCfg,
        IConfiguration recipientCfg, boolean transport) throws Exception {
        ...
        byte[] decryptedCMS = EnvelopedDataAsByteArrayExample
            .encryptDecrypt(signedCMS, true, recipientCfg, transport);
