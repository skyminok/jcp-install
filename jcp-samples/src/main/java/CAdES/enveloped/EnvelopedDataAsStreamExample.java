 ...
 * created 23.07.2014 18:19 by afevma
 ...
 * (plain text) на разных алгоритмах.
 *
 * @author Copyright 2004-2014 Crypto-Pro. All rights reserved.
 * @version 2.5
 */
public class EnvelopedDataAsStreamExample implements IEnvelopedData {
     ...
     * @throws Exception
     */
    public static void envelope(String dataPath, String tempPath,
        IConfiguration recipientConfig, boolean transport) throws Exception {
        // --- Зашифрование/расшифрование строки ---
        encryptDecrypt(recipientConfig, dataPath, DATA_FILE, tempPath, true, transport);
    }
     ...
     * @throws Exception
     */
    public static String encryptDecrypt(IConfiguration recipient,
        String dataPath, String dataFile, String tempPath,
        boolean compareArrays, boolean transport) throws Exception {

        String sourceFile = new File(dataPath, dataFile).getAbsolutePath();

        String envelopedFile = new File(tempPath, dataFile + recipient.getCertificate().hashCode() +
            (transport ? ".trans" : ".agree") + ".enveloped").getAbsolutePath();

        String decryptedFile = new File(tempPath, dataFile + recipient.getCertificate().hashCode() +
        ...
        encryptAsStream(recipient, sourceFile, envelopedFile, transport);
     ...
     * @throws Exception
     */
    private static void encryptAsStream(IConfiguration recipientConfig,
        String dataFile, String envelopedFile, boolean transport) throws Exception {
     ...
     * @throws Exception
     */
    private static void decryptAsStream(IConfiguration recipientConfig,
        String envelopedFile, String decryptedFile) throws Exception {

        try (InputStream encryptedDataFile = new FileInputStream(envelopedFile);
